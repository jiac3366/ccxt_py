...
from proto import market_service_pb2_grpc as market_pb2_grpc
import logging
...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("market_service.log")],
)
...
class MarketServicer(market_pb2_grpc.MarketServiceServicer):
    ...
    async def LoadMarkets(self, request, context):
        try:
            ...
            logger.info(
                f"Successfully processed {processed_count} markets "
